...
const values = [
  {
    title: "Do Big Things",
    description: "We dare to do big things, create big ideas, make big leaps, and take big risks."
  },
  {
    title: "We Before Me",
    description: "We work as a team to get the best from each other. No one can move a mountain alone."
  },
  {
    title: "Great Not Good",
    description: "We are obsessed with excellence and refuse to accept mediocrity or good enough."
  },
  {
    title: "Transparency",
    description: "We believe in complete transparency as it's the only way to build true partnerships with our clients."
  },
  {
    title: "Bullshit Free Design",
    description: "We create authentic designs based on your company's history and your customers' needs."
  },
  {
    title: "Effects Matter",
    description: "Positivity creates opportunity. We are optimistic about the future and promote creativity."
  }
]
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-gray-950 dark:text-white duration-200">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">About Print360°</h1>
        ...
        <div className="max-w-3xl mx-auto text-lg text-muted-foreground dark:text-gray-300">
          <p className="mb-6">
            Welcome to Print360°, where innovation meets precision in the world of printing and packaging. 
            With a passion for excellence and a commitment to delivering top-notch services, Print360° 
            stands as your trusted partner in the realm of bespoke printing solutions.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {customers.map((Logo, i) => (
              <div key={i} className="h-20 bg-white rounded-lg flex items-center justify-center">
                <img
                  src={Logo}
                  alt={`Client logo ${i + 1}`}
